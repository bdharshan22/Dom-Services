  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-black relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 mb-2 font-heading">My Dashboard</h1>
          <p className="text-gray-300 text-lg">Welcome back, {user?.name || 'Customer'}! Track your bookings and manage your services.</p>
        </div>
                ...
                {bookings.slice(0, 5).map((booking, index) => (
                  <div key={index} className="flex items-center space-x-4 p-3 bg-secondary-50 rounded-xl">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-secondary-800">{booking.serviceId?.name || booking.service}</p>
              ...
              {filteredBookings.map(booking => (
                <div key={booking._id} className="bg-white rounded-2xl shadow-lg p-6 border border-secondary-200 hover:shadow-xl transition-all duration-300">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <h4 className="text-lg font-bold text-secondary-800">{booking.serviceId?.name || booking.service}</h4>
